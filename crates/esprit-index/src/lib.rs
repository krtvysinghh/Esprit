...
pub use query::{
    all_files, all_files_in_workspace, file_relations, files_in_workspace, index_health,
    recover_index,
};
pub use search::{
    cached_search, filtered_search, intelligent_search, ranked_search, rebuild_search_index,
    rebuild_search_index_for_workspace, remove_search_document, search, search_with_metadata,
    semantic_search, sync_search_delete, sync_search_insert, sync_search_rename,
    update_search_document, workspace_search,
};
